...
#ifndef ALLYSTAR_BASE_WINDOW_H
#define ALLYSTAR_BASE_WINDOW_H
...
class AllyStar_base_window:public Base_MainWindow
{
  Q_OBJECT
 ...
 public:
  explicit AllyStar_base_window(QWidget *parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags());
  virtual  ~AllyStar_base_window();
  void cfg_model(AllyStar_Base* Base);
 ...
 protected:
  ...
  AllyStar_Base* AllyStarBase=nullptr;
