...
unsigned int  crc32_tab[] = 
{
 ...
 /* Teseo2 definitions */
 unsigned TESEO2_FLASHER_IDENTIFIER = 0xBCD501F4;
 unsigned TESEO2_FLASHER_SYNC = 0x83984073;


 int SERIAL_PORT_DEFAULT_TIMEOUT          = 2000;
 int SERIAL_PORT_ERASE_TIMEOUT            = 40000;
 int SERIAL_PORT_WAIT_FOR_ASIC_ID_TIMEOUT = 8000;
